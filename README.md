...
- Как уже было сказано выше, foreman не в состоянии работать с версиями ruby и гемов из debian 13, они слишком свежи, чтобы подойдти для зрелого продукта.  
...
- Отдельная история - репо puppet, оттуда вообще ничего скачать невозможно ни через ipv6, ни через ipv4, скорость рандомно падает ниже 1 Кб/си установка прерывается.  
